  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card text-white" style="border-radius: 1rem; background-color: #1f1f1f;">
            ...
            <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style="color: white;">Sign up</p>
                <form class="mx-1 mx-md-4" action="" method="POST">
                  ...
                  <!-- <div class="form-check d-flex justify-content-center mb-5">
                    ...
                    <label class="form-check-label" for="form2Example3" style="color: white;"> I agree all statements in <a href="#!" style="color: #e24e47;">Terms of service</a>
                    </label>
                  </div> -->
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <a href="loginpage.php"><button name="submit" type="submit" class="btn btn-lg"  style="background-color:  #e24e47; color: white;" >Register</button></a>
                  </div>
                </form>
          
              <div>
              <p class="mb-0">Already have an Account? <a href="loginpage.php" class="text-50 fw-bold" style="color: #e24e47">Log in</a>
              </p>
            </div>
          </div>
        </div>
